        ...
        super.init(
          {
            ...
            user_name: Sequelize.STRING, // Perde 'unique' e 'allowNull'
            email: Sequelize.STRING, // Perde 'unique', 'allowNull' e 'validate'
            password_hash: Sequelize.STRING, // Perde 'allowNull'
            password: Sequelize.VIRTUAL,
            tipo_usuario: Sequelize.ENUM('usuario', 'admin'), // Perde 'allowNull' e 'defaultValue'
